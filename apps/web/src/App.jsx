...
export default function App() {
  ...
  useEffect(() => { fetch('/api/products').then((response) => response.ok ? response.json() : Promise.reject()).then(setProducts).catch(() => {}); }, []);
